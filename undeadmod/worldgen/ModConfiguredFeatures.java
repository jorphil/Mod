...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldMetatorbernietOres = List.of(OreConfiguration.target(stoneReplaceable,
                ...
                register(context, OVERWORLD_METATORBERNITE_ORE_KEY, Feature.ORE, new OreConfiguration(overworldMetatorbernietOres, 9));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(UndeadMod.MOD_ID, name));
    }
